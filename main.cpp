...
void Calculator() {
    ...
    while (flag) {
        ...
        cout << "2) Octal" << endl;
        cout << "3) Decimal" << endl;
        cout << "4) Hexademical" << endl;
        cout << "0) Exit" << endl;
        cout << "================================================" << endl;
        int answer = -1;
        bool cinFail = true;
        while (answer < 0 || answer > 4 || cinFail == true) {
        ...
        case ('+'):
            switch (answer) {
            case (1):
                cout << "Your SUM is: " << DecToBinary(BinToDec() + BinToDec())
                    << endl;
                break;
            case (2):
                cinFail = true;
                ...
                break;
            case (3):
                cout << "Your SUM is: " << DecToHex(HexToDec() + HexToDec())
                    << endl;
                break;
            default:
                break;
        ...
        case ('-'):
            ...
            case (1):
                ...
                secNum = BinToDec();
                if (firstNum >= secNum) {
                    cout << "Your SUBSTRACTION is: " << DecToBinary(firstNum - secNum)
                        << endl;
                }
                else {
                    cout << "Your SUBSTRACTION is: -"
                        << DecToBinary(secNum - firstNum) << endl;
                }
                break;
            case (2):
                cinFail = true;
            ...
            case (3):
                ...
                secNum = HexToDec();
                if (firstNum >= secNum) {
                    cout << "Your SUBSTRACTION is: " << DecToHex(firstNum - secNum)
                        << endl;
                }
                else {
                    cout << "Your SUBSTRACTION is: -" << DecToHex(secNum - firstNum)
                        << endl;
                }
                break;
            default:
        ...
        case ('*'):
            ...
            case (1):
                cout << "Your MULTIPLICATION is: "
                    << DecToBinary(BinToDec() * BinToDec()) << endl;
                break;
            case (2):
                cinFail = true;
                while (cinFail) {
            ...
            case (3):
                cout << "Your MULTIPLICATION is: "
                    << DecToHex(HexToDec() * HexToDec()) << endl;
                break;
            default:
                break;
            }
        ...
        case ('/'):
            switch (answer) {
            case (1):
                cout << "Your DIVISION is: " << DecToBinary(BinToDec() / BinToDec())
                    << endl;
                break;
            case (2):
                cinFail = true;
                ...
                break;
            case (3):
                cout << "Your DIVISION is: " << DecToHex(HexToDec() / HexToDec())
                    << endl;
                break;
            default:
                break;
...
char getOperator() {
    while (true)  // цикл продолжается до тех пор, пока пользователь не введёт
                  // корректное значение
    {
        ...
        // Переменные типа char могут принимать любые символы из пользовательского
        // ввода,
        //поэтому нам не стоит беспокоиться по поводу возникновения неудачного
        //извлечения
...
string DecToBinary() {
    ...
    if (a == 0) {
        ...
        while (a > 0) {
            ...
            // Выполняем логическое ИЛИ и смотрим младший бит (был ли он равен 1
            // или 0)
...
int BinToDec() {
    ...
    for (size_t i = 0; it != biNum.begin(); i++) {
        ...
        if (*--it == '1') {
            number += 1 << i;  // После чего добавляем значение бита умноженное на
                               // степень этого бита (через битовый сдвиг)
        }
    }
    return number;
}
int HexToDec() {
    ...
    for (size_t i = 0; it != hexNum.begin(); i += 4) {
        ...
        number += (x << i);  // После чего добавляем значение бита умноженное на
                             // степень этого бита (через битовый сдвиг)
    }
    return number;
}
...
int OctToDec() {
    int octalNumber;
    cout << "Enter your positive octal number: " << endl;
    cin >> octalNumber;
...
void Converter() {
    ...
    while (flag) {
        ...
        cout << "7) From Decimal to Octal" << endl;
        cout << "8) From Octal to Decimal" << endl;

        cout << "0) Exit" << endl;
        cout << "================================================" << endl;
        int answer = -1;
        bool cinFail = true;
        while (answer < 0 || answer > 8 || cinFail == true) {
            cout << "Enter the number: ";
            cin >> answer;
            cinFail = cin.fail();
            cin.clear();
...
string BinToHex() { return DecToHex(BinToDec()); }
string HexToBin() { return DecToBinary(HexToDec()); }
